...
/* Modified by Sam Westrick, Darshan Dinesh Kumar, Seong-Heon Jung for
 * granularity analysis as described in:
 *   Scheduler Augmentation: A Lightweight, Customizable, Low-Cost Profiling Technique for Fork-Join Parallel Programs
 *   Sam Westrick, Darshan Dinesh Kumar, Seong-Heon Jung
 *   SPAA 2026
 */
